...
return [
    ...
    'mail' => [
        'subject'   => 'Your HOOR order :number',
        'greeting'  => 'Thank you, :name',
        'lead'      => 'We have your order and will call you shortly to confirm it.',
        'number'    => 'Order number',
        'placed'    => 'Placed on',
        'items'     => 'What you ordered',
        'delivery'  => 'Delivery address',
        'payment'   => 'Payment',
        'cod'       => 'Cash on delivery — you pay the courier when your order arrives.',
        'track'     => 'Track your order',
        'track_hint'=> 'Use your order number and the phone number above. No account needed.',
        'help'      => 'Questions? Reply to this email or call us on :phone.',
        'signoff'   => 'HOOR Denim Wear',
    ],
];
